...
$3 $4 \"../other_annotations/coding/CLIPdb/human_combined.merged.bed\" NA $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_CLIP $2 \
$3 $4 \"../other_annotations/coding/CLIP/human_combine.merged.bed\" NA $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_GERP $2 \
$3 $4 \"../other_annotations/conservation/Example_windows_coding_gerp_gt2.bed\" NA $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_ribosnitch $2 \
$3 $4 NA c\(\"../other_annotations/coding/ribosnitch/hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altA.bed\",\"../other_annotations/coding/ribosnitch/hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altC.bed\",\"../other_annotations/coding/ribosnitch/hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altG.bed\",\"../other_annotations/coding/ribosnitch/hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altT.bed\"\) $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_CLIPdb_ribosnitch $2 \
$3 $4 NA c\(\"../other_annotations/coding/CLIPdb/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altA.bed\",\"../other_annotations/coding/CLIPdb/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altC.bed\",\"../other_annotations/coding/CLIPdb/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altG.bed\",\"../other_annotations/coding/CLIPdb/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altT.bed\"\) $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_CLIP_ribosnitch $2 \
$3 $4 NA c\(\"../other_annotations/coding/CLIP/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altA.bed\",\"../other_annotations/coding/CLIP/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altC.bed\",\"../other_annotations/coding/CLIP/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altG.bed\",\"../other_annotations/coding/CLIP/human_combine.merged_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.05.merged.altT.bed\"\) $MutratePrefix
...
$3 $4 NA c\(\"../data/spidex_public_noncommercial_v1_0.tab_alt_A_lower10pct.bed\",\"../data/spidex_public_noncommercial_v1_0.tab_alt_C_lower10pct.bed\",\"../data/spidex_public_noncommercial_v1_0.tab_alt_G_lower10pct.bed\",\"../data/spidex_public_noncommercial_v1_0.tab_alt_T_lower10pct.bed\"\) $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_Mis3 $2 \
$3 $4 NA c\(\"../other_annotations/coding/Polyphen_HDIV_probably_damaging_altA.bed.merge.bed\",\"../other_annotations/coding/Polyphen_HDIV_probably_damaging_altC.bed.merge.bed\",\"../other_annotations/coding/Polyphen_HDIV_probably_damaging_altG.bed.merge.bed\",\"../other_annotations/coding/Polyphen_HDIV_probably_damaging_altT.bed.merge.bed\"\) $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_LoF $2 \
$3 $4 NA c\(\"../other_annotations/coding/171121_coding_stop_loss_and_gain_SNV_altA.bed.merge.bed\",\"../other_annotations/coding/171121_coding_stop_loss_and_gain_SNV_altC.bed.merge.bed\",\"../other_annotations/coding/171121_coding_stop_loss_and_gain_SNV_altG.bed.merge.bed\",\"../other_annotations/coding/171121_coding_stop_loss_and_gain_SNV_altT.bed.merge.bed\"\) $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_CADD $2 \
$3 $4 NA c\(\"../other_annotations/allele_specific_CADD/Example_windows_coding_SNVs_gt15_altA.bed\",\"../other_annotations/allele_specific_CADD/Example_windows_coding_SNVs_gt15_altC.bed\",\"../other_annotations/allele_specific_CADD/Example_windows_coding_SNVs_gt15_altG.bed\",\"../other_annotations/allele_specific_CADD/Example_windows_coding_SNVs_gt15_altT.bed\"\) $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_Ray_RBP_motif $2 \
$3 $4 \"../other_annotations/coding/Ray_et_al_RBP_motif_hits/A_Up_Down.best_hit.hg19.bed.merge.bed\" NA $MutratePrefix

bash ../lib/180215_print_partitioned_R_script_for_RR_estimate_nonAS_annotations.sh $1_RBP_Var_Level2 $2 \
$3 $4 NA c\(\"../other_annotations/coding/RBP-VarDB/RBP.all.bed.merge_overlap_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.1.altA.bed.merge.bed\",\"../other_annotations/coding/RBP-VarDB/RBP.all.bed.merge_overlap_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.1.altC.bed.merge.bed\",\"../other_annotations/coding/RBP-VarDB/RBP.all.bed.merge_overlap_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.1.altG.bed.merge.bed\",\"../other_annotations/coding/RBP-VarDB/RBP.all.bed.merge_overlap_hg19_refGenes_exons.gtf.lg.transc.fa.RNAsnpM3.bed.abspos.p0.1.altT.bed.merge.bed\"\) $MutratePrefix
